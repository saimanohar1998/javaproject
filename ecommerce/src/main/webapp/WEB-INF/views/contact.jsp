...
<link href="css/contactt.css" rel="stylesheet" type="text/css" media="all" />
...
<div class="container">
	...
	<h1>CONTACT US</h1><br>
	<h2>Address</h2><br>
	<h4>83,4th Avenue,<br>Sundar Nagar,<br>Ekkattuthangal,<br>Chennai-600032,<br>Tamil Nadu,<br>INDIA.</h4>
	<br>
	(or)
	<br>
	<h4>32A,Thanakotti<br>Raja Street,<br>Ekkattuthangal,<br>Chennai-600032,<br>Tamil Nadu,<br>INDIA.</h4>
	<br>
	...
	(or)
	<br>
	<h4>MOBILE: +91 9176095549</h4>
	<br>
		<h2>E-MAIL</h2><br>
	<h4>mkumaravel07@gmail.com</h4>
	<br>
	(or)
	<br>
	<h4>saraswathiprinters@yahoo.com</h4>
	</div></div>
...
<div class="footer">
		...
		<p >© 2016 New Store All Rights Reserved | Design by  <a href="#" target="_blank">Muthu Kumaravel</a> </p>
		</div>
		</div>
