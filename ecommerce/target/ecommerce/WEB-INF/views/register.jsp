...
<link href="css/registerr.css" rel="stylesheet" type="text/css" media="all" />
	...
	<div class="login-container">
            ...
            <div class="form-box">
                <form action="" method="">
					...
					<input type="radio" name="gender" value="female"><h6>Female</h6><br><br>
					...
					<input name="rp" type="password" required placeholder="re-enter password">
...
$('button[type="submit"]').click(function(e) {
                ...
                if ((p.val() != "")&&(textfield.val() != "")&&(fn.val() !="")&&(ln.val() !="")&&(rp.val() != "")&&(rp.val()==p.val())&&(filter.test(email.value))&&(passw.test(password.value))&&(chec.test(fname.value))&&(checc.test(lname.value))) {
                    ...
                    $("#output").addClass("alert alert-success animated fadeInUp").html("Welcome to Shopping.com " + "<span style='text-transform:uppercase'>" + textfield.val() + "</span>");
